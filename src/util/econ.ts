...
export interface CEconItemPreviewDataBlock_Sticker {
  ...
  tintId?: number;
  /**
   * @generated from protobuf field: optional uint32 offset_x = 7;
   */
  offsetX?: number;
  /**
   * @generated from protobuf field: optional uint32 offset_y = 8;
   */
  offsetY?: number;
}
...
class CEconItemPreviewDataBlock$Type extends MessageType<CEconItemPreviewDataBlock> {
  constructor() {
    super('CEconItemPreviewDataBlock', [
      ...
      },
      {
        ...
        T: () => CEconItemPreviewDataBlock_Sticker,
      },
      {
        no: 13,
        name: 'inventory',
  ...
  override create(
    value?: PartialMessage<CEconItemPreviewDataBlock>,
  ...
  override internalBinaryRead(
    ...
    target?: CEconItemPreviewDataBlock,
  ): CEconItemPreviewDataBlock {
      ...
      switch (fieldNo) {
        ...
        case /* repeated CEconItemPreviewDataBlock.Sticker stickers */ 12:
          message.stickers.push(
            CEconItemPreviewDataBlock_Sticker.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
  ...
  override internalBinaryWrite(
    ...
    for (let i = 0; i < message.stickers.length; i++)
      CEconItemPreviewDataBlock_Sticker.internalBinaryWrite(
        message.stickers[i],
...
class CEconItemPreviewDataBlock_Sticker$Type extends MessageType<CEconItemPreviewDataBlock_Sticker> {
  ...
  override create(
    value?: PartialMessage<CEconItemPreviewDataBlock_Sticker>,
  ): CEconItemPreviewDataBlock_Sticker {
    const message = globalThis.Object.create(this.messagePrototype!);
    if (value !== undefined)
      reflectionMergePartial<CEconItemPreviewDataBlock_Sticker>(
        this,
        message,
        value,
      );
  ...
  override internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: CEconItemPreviewDataBlock_Sticker,
  ): CEconItemPreviewDataBlock_Sticker {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* optional uint32 tint_id */ 6:
          ...
          break;
        case /* optional uint32 offset_x */ 7:
          message.offsetX = reader.uint32();
          break;
        case /* optional uint32 offset_y */ 8:
  ...
  override internalBinaryWrite(
    ...
    /* optional uint32 offset_x = 7; */
    if (message.offsetX !== undefined)
      writer.tag(7, WireType.Varint).uint32(message.offsetX);
    /* optional uint32 offset_y = 8; */
    if (message.offsetY !== undefined)
      writer.tag(8, WireType.Varint).uint32(message.offsetY);
    let u = options.writeUnknownFields;
    if (u !== false)
      (u == true ? UnknownFieldHandler.onWrite : u)(
        this.typeName,
...
export const CEconItemPreviewDataBlock_Sticker =
  new CEconItemPreviewDataBlock_Sticker$Type();
